...
dXdt[1] = ((1.0/2.0)*tanh((X[0] - p[7])/p[8]) - X[1] + 1.0/2.0)/(p[9] + p[10]/pow(cosh((X[0] - p[11])/p[12]), 2));
dXdt[2] = ((1.0/2.0)*tanh((X[0] - p[13])/p[14]) - X[2] + 1.0/2.0)/(p[15] + p[16]/pow(cosh((X[0] - p[17])/p[18]), 2));
dXdt[3] = ((1.0/2.0)*tanh((X[0] - p[19])/p[20]) - X[3] + 1.0/2.0)/(p[21] + p[22]/pow(cosh((X[0] - p[23])/p[24]), 2));
        }
};
